...
// Must stay in sync with the type oneof on the ParameterValue message
...
func (m *ParameterValue) GetFloat() float64 {
...
func _ParameterValue_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 4: // type.float
		...
		m.Type = &ParameterValue_Float{math.Float64frombits(x)}
		return true, err
	case 5: // type.date
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
var fileDescriptor_d1ad3a89626d72ea = []byte{
	...
	,
}
