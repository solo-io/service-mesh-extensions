...
type SpecReader interface {
	GetSpecs() ([]*hubv1.ApplicationSpec, error)
}
...
var (
	...
	FailedToReadFileError = func(err error) error {
		return errors.Wrap(err, "Failed to read local registry")
	}
)
...
func (r *RemoteSpecReader) GetSpecs() ([]*hubv1.ApplicationSpec, error) {
...
func NewLocalSpecReader(ctx context.Context, file string) *LocalSpecReader {
...
func (l *LocalSpecReader) GetSpecs() ([]*hubv1.ApplicationSpec, error) {
	specYaml, err := ioutil.ReadFile(l.file)
	if err != nil {
		wrapped := FailedToReadFileError(err)
		return nil, wrapped
	}
...
func getSpecsFromBytes(bytes []byte) ([]*hubv1.ApplicationSpec, error) {
	var specsMessage hubv1.ApplicationSpecs
...
type GithubSpecReader struct {
	ctx      context.Context
	location hubv1.GithubRepositoryLocation
}

func (r *GithubSpecReader) GetSpecs() ([]*hubv1.ApplicationSpec, error) {
	...
	var specs []*hubv1.ApplicationSpec
...
func NewGithubSpecReader(ctx context.Context, location hubv1.GithubRepositoryLocation) *GithubSpecReader {
